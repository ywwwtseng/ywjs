...
var validate = (params, schema) => {
  ...
  for (let index = 0; index < keys.length; index++) {
    ...
    if (schema[key].required && params[key] === void 0) {
      return {
      ...
      } else if (schema[key].type === "boolean" && typeof params[key] !== "boolean") {
        return {
...
var allowed = (params, schema) => {
  ...
  for (let index = 0; index < keys.length; index++) {
    ...
    } else if (schema[key].type === "number" && typeof params[key] !== "number") {
      return {
